# 1 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c" 2
# 90 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
...
# 91 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c" 2
# 111 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
static void DMA_SetConfig(DMA_HandleTypeDef *hdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t DataLength);
static void DMA_CalcDMAMUXChannelBaseAndMask(DMA_HandleTypeDef *hdma);
static void DMA_CalcDMAMUXRequestGenBaseAndMask(DMA_HandleTypeDef *hdma);
# 150 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
HAL_StatusTypeDef HAL_DMA_Init(DMA_HandleTypeDef *hdma)
{
  uint32_t tmp;
...
# 379 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
HAL_StatusTypeDef HAL_DMA_Start(DMA_HandleTypeDef *hdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t DataLength)
{
...
# 422 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
HAL_StatusTypeDef HAL_DMA_Start_IT(DMA_HandleTypeDef *hdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t DataLength)
{
  HAL_StatusTypeDef status = HAL_OK;
...
# 609 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
HAL_StatusTypeDef HAL_DMA_PollForTransfer(DMA_HandleTypeDef *hdma, HAL_DMA_LevelCompleteTypeDef CompleteLevel, uint32_t Timeout)
{
  uint32_t temp;
  uint32_t tickstart;
...
void HAL_DMA_IRQHandler(DMA_HandleTypeDef *hdma)
{
  ...
  if (((flag_it & ((0x1UL << (2U)) << (hdma->ChannelIndex & 0x1CU))) != 0U) && ((source_it & (0x1UL << (2U))) != 0U))
  {
    ...
    if(((hdma->Instance->CCR) & (uint32_t)((0x1UL << (15U)))) != 0U)
    {

      hdma->DmaBaseAddress->IFCR = (0x1UL << (2U)) << (hdma->ChannelIndex & 0x1CU);


      if((hdma->Instance->CCR & (0x1UL << (16U))) == 0U)
      {
...
# 885 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
HAL_StatusTypeDef HAL_DMA_RegisterCallback(DMA_HandleTypeDef *hdma, HAL_DMA_CallbackIDTypeDef CallbackID, void (* pCallback)( DMA_HandleTypeDef * _hdma))
{
  HAL_StatusTypeDef status = HAL_OK;
...
# 944 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
HAL_StatusTypeDef HAL_DMA_UnRegisterCallback(DMA_HandleTypeDef *hdma, HAL_DMA_CallbackIDTypeDef CallbackID)
{
  HAL_StatusTypeDef status = HAL_OK;
...
# 1032 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
HAL_DMA_StateTypeDef HAL_DMA_GetState(DMA_HandleTypeDef *hdma)
{
...
# 1086 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
HAL_StatusTypeDef HAL_DMA_ConfigChannelAttributes(DMA_HandleTypeDef *hdma, uint32_t ChannelAttributes)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint32_t ccr;
  ...
  ccr = ((hdma->Instance->CCR));


  if ((ChannelAttributes & ((0x1UL << (20U)) >> 16U)) != 0U)
  {
    if((ChannelAttributes & (0x1UL << (20U))) != 0U)
    {
      ((ccr) |= ((0x1UL << (20U))));
    }
    else
...
# 1202 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
  ((hdma->Instance->CCR) = (ccr));

  return status;
}
# 1216 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
HAL_StatusTypeDef HAL_DMA_GetConfigChannelAttributes(DMA_HandleTypeDef *hdma, uint32_t *ChannelAttributes)
{
  ...
  if((hdma == 0) || (ChannelAttributes == 0))
  {
    return HAL_ERROR;
  }
# 1245 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
  read_attributes = ((hdma->Instance->CCR) & ((0x1UL << (20U))));

  attributes = ((read_attributes & (0x1UL << (20U))) == 0U) ? (((0x1UL << (20U)) >> 16U)) : (((0x1UL << (20U)) >> 16U) | (0x1UL << (20U)));
...
# 1269 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
static void DMA_SetConfig(DMA_HandleTypeDef *hdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t DataLength)
{
...
static void DMA_CalcDMAMUXChannelBaseAndMask(DMA_HandleTypeDef *hdma)
{
  ...
  if ((uint32_t)hdma->Instance < (uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0008UL)))
  {
    ...
    hdma->DMAmuxChannel = (((DMAMUX_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0800UL))) + (hdma->ChannelIndex >> 2U));
  }
  else
  {

    hdma->DMAmuxChannel = (((DMAMUX_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0800UL) + 0x00000020UL)) + (hdma->ChannelIndex >> 2U));
  }

  channel_number = (((uint32_t)hdma->Instance & 0xFFU) - 8U) / 20U;
  hdma->DMAmuxChannelStatus = ((DMAMUX_ChannelStatus_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0800UL) + 0x00000080UL));
  hdma->DMAmuxChannelStatusMask = 1UL << (channel_number & 0x1FU);
}
# 1340 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_dma.c"
static void DMA_CalcDMAMUXRequestGenBaseAndMask(DMA_HandleTypeDef *hdma)
{
  uint32_t request = hdma->Init.Request & (0xFFUL << (0U));


  hdma->DMAmuxRequestGen = (DMAMUX_RequestGen_TypeDef *)((uint32_t)(((uint32_t)((DMAMUX_RequestGen_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0800UL) + 0x00000100UL))) + ((request - 1U) * 4U)));

  hdma->DMAmuxRequestGenStatus = ((DMAMUX_RequestGenStatus_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0800UL) + 0x00000140UL));
