# 1 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_comp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_comp.c" 2
# 163 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_comp.c"
...
# 164 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_comp.c" 2
# 233 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_comp.c"
HAL_StatusTypeDef HAL_COMP_Init(COMP_HandleTypeDef *hcomp)
{
  uint32_t tmp_csr;
  uint32_t exti_line;
  ...
  else if(((((hcomp)->Instance->CSR) & ((0x1UL << (31U)))) == (0x1UL << (31U))))
  {
    status = HAL_ERROR;
  }
  else
  {
    ...
    if(hcomp->State == HAL_COMP_STATE_RESET)
    {
      ...
      ((hcomp)->ErrorCode = (0x00UL));
# 291 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_comp.c"
      HAL_COMP_MspInit(hcomp);

    }


    comp_voltage_scaler_initialized = ((hcomp->Instance->CSR) & ((0x1UL << (23U))));
    ...
    (((hcomp->Instance->CSR)) = ((((((hcomp->Instance->CSR))) & (~((0x3UL << (2U)) | (0x7UL << (4U)) | (0x3UL << (7U)) | (0x1UL << (9U)) | (0x1UL << (15U)) | (0x3UL << (16U)) | (0x7UL << (18U)) | (0x1UL << (22U)) | (0x1UL << (23U))))) | (tmp_csr))));
# 320 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_comp.c"
    if(hcomp->Init.WindowMode == ((0x1UL << (9U))))
    {
      ((((COMP_Common_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0204UL))->CSR) |= ((0x1UL << (9U))));
    }
    else
    {
      ((((COMP_Common_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0204UL))->CSR) &= ~((0x1UL << (9U))));
    ...
    if ((((hcomp->Instance->CSR) & ((0x1UL << (23U)))) != 0UL) &&
        (comp_voltage_scaler_initialized == 0UL) )
    {
      ...
      wait_loop_index = (((200UL) / 10UL) * (SystemCoreClock / (100000UL * 2UL)));
    ...
    exti_line = (((hcomp->Instance) == ((COMP_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0200UL))) ? ((0x1UL << (21U))) : ((0x1UL << (22U))));


    if((hcomp->Init.TriggerMode & ((0x00000001UL) | (0x00000002UL))) != 0UL)
    {

      if((hcomp->Init.TriggerMode & (0x00000010UL)) != 0UL)
      {
      ...
      if((hcomp->Init.TriggerMode & (0x00000020UL)) != 0UL)
      {
      ...
      if((hcomp->Init.TriggerMode & (0x00000002UL)) != 0UL)
      {
      ...
      if((hcomp->Init.TriggerMode & (0x00000001UL)) != 0UL)
      {
...
# 423 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_comp.c"
HAL_StatusTypeDef HAL_COMP_DeInit(COMP_HandleTypeDef *hcomp)
{
  HAL_StatusTypeDef status = HAL_OK;
  ...
  else
  {
    ...
    ((hcomp->Instance->CSR) = (0x00000000UL));
# 454 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_comp.c"
    ...
    do{ (hcomp)->Lock = HAL_UNLOCKED; }while (0);
  }
...
__attribute__((weak)) void HAL_COMP_MspInit(COMP_HandleTypeDef *hcomp)
{
...
__attribute__((weak)) void HAL_COMP_MspDeInit(COMP_HandleTypeDef *hcomp)
{
...
# 681 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_comp.c"
HAL_StatusTypeDef HAL_COMP_Start(COMP_HandleTypeDef *hcomp)
{
  volatile uint32_t wait_loop_index = 0UL;
  HAL_StatusTypeDef status = HAL_OK;
  ...
  else
  {
    ...
    if(hcomp->State == HAL_COMP_STATE_READY)
    {
      ...
      wait_loop_index = (((80UL) / 10UL) * (SystemCoreClock / (100000UL * 2UL)));
      while(wait_loop_index != 0UL)
      {
        wait_loop_index--;
      }
...
void HAL_COMP_IRQHandler(COMP_HandleTypeDef *hcomp)
{
  ...
  uint32_t exti_line = (((hcomp->Instance) == ((COMP_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0200UL))) ? ((0x1UL << (21U))) : ((0x1UL << (22U))));


  if(LL_EXTI_IsActiveRisingFlag_0_31(exti_line) != 0UL)
  {

    if(((((COMP_Common_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0204UL))->CSR) & ((0x1UL << (9U)))) != 0UL)
    {
      ...
      LL_EXTI_ClearRisingFlag_0_31((((0x1UL << (21U))) | ((0x1UL << (22U)))));
    }
    else
    {
  ...
  else if(LL_EXTI_IsActiveFallingFlag_0_31(exti_line) != 0UL)
  {
    ...
    if(((((COMP_Common_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0204UL))->CSR) & ((0x1UL << (9U)))) != 0UL)
    {
      ...
      LL_EXTI_ClearFallingFlag_0_31((((0x1UL << (21U))) | ((0x1UL << (22U)))));
    }
    else
    {
...
# 867 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_comp.c"
HAL_StatusTypeDef HAL_COMP_Lock(COMP_HandleTypeDef *hcomp)
{
  HAL_StatusTypeDef status = HAL_OK;
  ...
  if(status == HAL_OK)
  {
    ...
    (((hcomp)->Instance->CSR) |= ((0x1UL << (31U))));
  }

  return status;
}
# 928 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_comp.c"
uint32_t HAL_COMP_GetOutputLevel(COMP_HandleTypeDef *hcomp)
{

  ((void)0U);

  return (uint32_t)(((hcomp->Instance->CSR) & ((0x1UL << (30U))))
                    >> (30UL));
}
...
__attribute__((weak)) void HAL_COMP_TriggerCallback(COMP_HandleTypeDef *hcomp)
{
...
# 976 "c:/Keil_v5/ARM/PACK/Keil/STM32L5xx_DFP/1.3.0/Drivers/STM32L5xx_HAL_Driver/Src/stm32l5xx_hal_comp.c"
HAL_COMP_StateTypeDef HAL_COMP_GetState(COMP_HandleTypeDef *hcomp)
{
